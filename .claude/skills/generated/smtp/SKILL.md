---
name: smtp
description: "Skill for the Smtp area of mh2030_demo. 31 symbols across 5 files."
---

# Smtp

31 symbols | 5 files | Cohesion: 66%
...
| `middlewares/3rd_party/lwip-2.1.2/src/core/altcp.c` | altcp_write, altcp_default_write |
| `middlewares/3rd_party/lwip-2.1.2/src/core/pbuf.c` | pbuf_strstr |
| `middlewares/3rd_party/lwip-2.1.2/src/apps/altcp_tls/altcp_tls_mbedtls.c` | altcp_mbedtls_bio_send |
| `middlewares/3rd_party/lwip-2.1.2/src/apps/http/altcp_proxyconnect.c` | altcp_proxyconnect_write |
...
| `smtp_tcp_err` | Function | `middlewares/3rd_party/lwip-2.1.2/src/apps/smtp/smtp.c` | 298 |
| `smtp_free_struct` | Function | `middlewares/3rd_party/lwip-2.1.2/src/apps/smtp/smtp.c` | 444 |
