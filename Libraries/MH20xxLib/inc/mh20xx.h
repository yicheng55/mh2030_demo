...
/* Uncomment the line below according to the target MH20XX device used in your 
   application 
  */
...
/**
 * @brief MH20XXxx Standard Peripheral Library version number V1.2.0
   */
#define __MH20XX_STDPERIPH_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __MH20XX_STDPERIPH_VERSION_SUB1   (0x02) /*!< [23:16] sub1 version */
#define __MH20XX_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __MH20XX_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __MH20XX_STDPERIPH_VERSION        ((__MH20XX_STDPERIPH_VERSION_MAIN << 24)\
                                             |(__MH20XX_STDPERIPH_VERSION_SUB1 << 16)\
                                             |(__MH20XX_STDPERIPH_VERSION_SUB2 << 8)\
                                             |(__MH20XX_STDPERIPH_VERSION_RC))
...
/**
 * @brief MH20XXxx Interrupt Number Definition, according to the selected device 
 *        in @ref Library_configuration_section 
 */
#define __CM0_REV                 0 /*!< Core Revision r0p0                            */
#define __MPU_PRESENT             0 /*!< MH20XXxx do not provide MPU                  */
#define __NVIC_PRIO_BITS          2 /*!< MH20XXxx uses 2 Bits for the Priority Levels */
...
/******  Cortex-M0 Processor Exceptions Numbers ******************************************************/
  ...
  USART3_6_IRQn               = 29,     /*!< USART3 and USART6 Interrupts                                  */
  ALU_IRQn               	  = 30,     /*!< ALU Interrupts                                        */
...
typedef struct
{
  ...
  uint16_t  RESERVED5;  /*!< Reserved, 0x2A                                                 */
	__IO uint32_t  CR4;				/*!< USART Control register 4,                 Address offset: 0x2C */
} USART_TypeDef;
...
#define OPA1_BASE		  	  (APBPERIPH_BASE + 0x00010024)
#define OPA2_BASE		  	  (APBPERIPH_BASE + 0x00010028)
#define OPA3_BASE		  	  (APBPERIPH_BASE + 0x0001002C)
...
#define DIVQSRT_BASE		  (AHB2PERIPH_BASE + 0x00004000)
...
#define DIVQSRT				((DIVSQRT_TypeDef *)DIVQSRT_BASE)
...
#define  ADC_CFGR2_JITOFFDIV8                 ((uint32_t)0xC0000000)       /*!< Jitter Off when ADC clocked by PCLK div8 */
...
#define  RCC_CFGR_PLLMULL                    ((uint32_t)0x007C0000)        /*!< PLLMUL[4:0] bits (PLL multiplication factor) */
#define  RCC_CFGR_PLLMULL_0                  ((uint32_t)0x00040000)        /*!< Bit 0 */
#define  RCC_CFGR_PLLMULL_1                  ((uint32_t)0x00080000)        /*!< Bit 1 */
#define  RCC_CFGR_PLLMULL_2                  ((uint32_t)0x00100000)        /*!< Bit 2 */
#define  RCC_CFGR_PLLMULL_3                  ((uint32_t)0x00200000)        /*!< Bit 3 */
#define  RCC_CFGR_PLLMULL_4                  ((uint32_t)0x00400000)        /*!< Bit 4 */
...
#define  RCC_CFGR_PLLMULL17                  ((uint32_t)0x00400000)        /*!< PLL input clock*17 */
#define  RCC_CFGR_PLLMULL18                  ((uint32_t)0x00440000)        /*!< PLL input clock*18 */
#define  RCC_CFGR_PLLMULL19                  ((uint32_t)0x00480000)        /*!< PLL input clock*19 */
#define  RCC_CFGR_PLLMULL20                  ((uint32_t)0x004C0000)        /*!< PLL input clock*20 */
#define  RCC_CFGR_PLLMULL21                  ((uint32_t)0x00500000)        /*!< PLL input clock*21 */
#define  RCC_CFGR_PLLMULL22                  ((uint32_t)0x00540000)        /*!< PLL input clock*22 */
#define  RCC_CFGR_PLLMULL23                  ((uint32_t)0x00580000)        /*!< PLL input clock*23 */
#define  RCC_CFGR_PLLMULL24                  ((uint32_t)0x005C0000)        /*!< PLL input clock*24 */
#define  RCC_CFGR_PLLMULL25                  ((uint32_t)0x00600000)        /*!< PLL input clock*25 */
#define  RCC_CFGR_PLLMULL26                  ((uint32_t)0x00640000)        /*!< PLL input clock*26 */
#define  RCC_CFGR_PLLMULL27                  ((uint32_t)0x00680000)        /*!< PLL input clock*27 */
#define  RCC_CFGR_PLLMULL28                  ((uint32_t)0x006C0000)        /*!< PLL input clock*28 */
#define  RCC_CFGR_PLLMULL29                  ((uint32_t)0x00700000)        /*!< PLL input clock*29 */
#define  RCC_CFGR_PLLMULL30                  ((uint32_t)0x00740000)        /*!< PLL input clock*30 */
#define  RCC_CFGR_PLLMULL31                  ((uint32_t)0x00780000)        /*!< PLL input clock*31 */
#define  RCC_CFGR_PLLMULL32                  ((uint32_t)0x007C0000)        /*!< PLL input clock*32 */
