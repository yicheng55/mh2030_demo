...
#ifndef __MH20XX_FLASH_H
#define __MH20XX_FLASH_H
...
/** @defgroup FLASH_Option_Bytes_nRMH_MHOP 
  * @{
  */

#define OB_MHOP_NoRMH                  ((uint8_t)0x02) /*!< No reset generated when entering in MHOP */
#define OB_MHOP_RMH                    ((uint8_t)0x00) /*!< Reset generated when entering in MHOP */
#define IS_OB_MHOP_SOURCE(SOURCE) (((SOURCE) == OB_MHOP_NoRMH) || ((SOURCE) == OB_MHOP_RMH))

/**
  * @}
  */

/** @defgroup FLASH_Option_Bytes_nRMH_MHDBY 
  * @{
  */

#define OB_MHDBY_NoRMH                 ((uint8_t)0x04) /*!< No reset generated when entering in MHANDBY */
#define OB_MHDBY_RMH                   ((uint8_t)0x00) /*!< Reset generated when entering in MHANDBY */
#define IS_OB_MHDBY_SOURCE(SOURCE) (((SOURCE) == OB_MHDBY_NoRMH) || ((SOURCE) == OB_MHDBY_RMH))
