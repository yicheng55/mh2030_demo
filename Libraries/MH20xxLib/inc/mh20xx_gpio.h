...
#ifndef __MH20XX_GPIO_H
#define __MH20XX_GPIO_H
...
#define IS_GPIO_LIMH_PERIPH(PERIPH) (((PERIPH) == GPIOA) || \
                                     ((PERIPH) == GPIOB))
...
/** @defgroup GPIO_pins_ds
  * @{
  */
#define GPIO_Ds_Low                 ((uint16_t)0x0000)  
#define GPIO_Ds_Medium              ((uint16_t)0x0001) 
#define GPIO_Ds_MediumHigh          ((uint16_t)0x0002)  
#define GPIO_Ds_High                ((uint16_t)0x0003) 

#define IS_GET_GPIO_DS(DS) (((DS) == GPIO_Ds_Low) || \
                              ((DS) == GPIO_Ds_Medium) || \
                              ((DS) == GPIO_Ds_MediumHigh) || \
															((DS) == GPIO_Ds_High))
...
/** 
  ...
  */
#define GPIO_AF_4            ((uint8_t)0x04) /* TIM14, I2C1*/
/** 
...
/** 
  ...
  */
#define GPIO_AF_8            ((uint8_t)0x08) /* SPI2, TIM1, USART2 */
...
void GPIO_DsConfig(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, uint8_t GPIO_Ds);
#ifdef __cplusplus
}
#endif

#endif /* __MH20XX_GPIO_H */
/**
  * @}
  */
