...
#ifndef __MH20XX_I2C_H
#define __MH20XX_I2C_H
...
#define IS_I2C_REGIMHER(REGIMHER)       (((REGIMHER) == I2C_Register_CR1) || \
                                         ((REGIMHER) == I2C_Register_CR2) || \
                                         ((REGIMHER) == I2C_Register_OAR1) || \
                                         ((REGIMHER) == I2C_Register_OAR2) || \
                                         ((REGIMHER) == I2C_Register_TIMINGR) || \
                                         ((REGIMHER) == I2C_Register_TIMEOUTR) || \
                                         ((REGIMHER) == I2C_Register_ISR) || \
                                         ((REGIMHER) == I2C_Register_ICR) || \
                                         ((REGIMHER) == I2C_Register_PECR) || \
                                         ((REGIMHER) == I2C_Register_RXDR) || \
                                         ((REGIMHER) == I2C_Register_TXDR))
/**
  * @}
  */
...
#define I2C_IT_MHOPI                    I2C_CR1_MHOPIE
