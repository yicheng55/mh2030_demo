...
#ifndef __MH20XX_RCC_H
#define __MH20XX_RCC_H
...
#define RCC_PLLSource_HSE            	 RCC_CFGR_PLLSRC_PREDIV1
...
#define RCC_PLLMul_17                   RCC_CFGR_PLLMULL17
#define RCC_PLLMul_18                   RCC_CFGR_PLLMULL18
#define RCC_PLLMul_19                   RCC_CFGR_PLLMULL19
#define RCC_PLLMul_20                   RCC_CFGR_PLLMULL20
#define RCC_PLLMul_21                   RCC_CFGR_PLLMULL21
#define RCC_PLLMul_22                   RCC_CFGR_PLLMULL22
#define RCC_PLLMul_23                   RCC_CFGR_PLLMULL23
#define RCC_PLLMul_24                   RCC_CFGR_PLLMULL24
#define RCC_PLLMul_25                   RCC_CFGR_PLLMULL25
#define RCC_PLLMul_26                   RCC_CFGR_PLLMULL26
#define RCC_PLLMul_27                   RCC_CFGR_PLLMULL27
#define RCC_PLLMul_28                   RCC_CFGR_PLLMULL28
#define RCC_PLLMul_29                   RCC_CFGR_PLLMULL29
#define RCC_PLLMul_30                   RCC_CFGR_PLLMULL30
#define RCC_PLLMul_31                   RCC_CFGR_PLLMULL31
#define RCC_PLLMul_32                   RCC_CFGR_PLLMULL32
#define IS_RCC_PLL_MUL(MUL) (((MUL) == RCC_PLLMul_2) || ((MUL) == RCC_PLLMul_3)   || \
                             ...
                             ((MUL) == RCC_PLLMul_16) || ((MUL) == RCC_PLLMul_17) || \
							 ((MUL) == RCC_PLLMul_18) || ((MUL) == RCC_PLLMul_19) || \
							 ((MUL) == RCC_PLLMul_20) || ((MUL) == RCC_PLLMul_21) || \
							 ((MUL) == RCC_PLLMul_22) || ((MUL) == RCC_PLLMul_23) || \
							 ((MUL) == RCC_PLLMul_24) || ((MUL) == RCC_PLLMul_25) || \
							 ((MUL) == RCC_PLLMul_26) || ((MUL) == RCC_PLLMul_27) || \
							 ((MUL) == RCC_PLLMul_28) || ((MUL) == RCC_PLLMul_29) || \
							 ((MUL) == RCC_PLLMul_30) || ((MUL) == RCC_PLLMul_31) || \
							 ((MUL) == RCC_PLLMul_32))
/**
  * @}
  */
...
#define RCC_ADCCLK_PCLK_Div8             ((uint32_t)0x01004000)
#define IS_RCC_ADCCLK(ADCCLK) (((ADCCLK) == RCC_ADCCLK_HSI14) || ((ADCCLK) == RCC_ADCCLK_PCLK_Div2) || \
                               ((ADCCLK) == RCC_ADCCLK_PCLK_Div4) || ((ADCCLK) == RCC_ADCCLK_PCLK_Div8))
...
#define RCC_AHBPeriph_DIVQSRT             ((uint32_t)0x80000000)
#define IS_RCC_AHB_PERIPH(PERIPH) ((((PERIPH) & 0xFFFFFFFF) != 0x00) && ((PERIPH) != 0x00))
#define IS_RCC_AHB_RMH_PERIPH(PERIPH) ((((PERIPH) & 0xFFFFFFFF) != 0x00) && ((PERIPH) != 0x00))
...
#define IS_RCC_APB2_PERIPH(PERIPH) ((((PERIPH) & 0xFFFFFFFF) != 0x00) && ((PERIPH) != 0x00))
...
#define IS_RCC_APB1_PERIPH(PERIPH) ((((PERIPH) & 0xFFFFFFFF) != 0x00) && ((PERIPH) != 0x00))
/**
  * @}
  */
