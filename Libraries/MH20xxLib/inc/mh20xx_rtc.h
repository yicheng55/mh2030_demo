...
#ifndef __MH20XX_RTC_H
#define __MH20XX_RTC_H
...
#define IS_RTC_TIMEMHAMP_EDGE(EDGE) (((EDGE) == RTC_TimeStampEdge_Rising) || \
...
#define IS_RTC_MHORE_OPERATION(OPERATION) (((OPERATION) == RTC_StoreOperation_Reset) || \
...
#define IS_RTC_GET_FLAG(FLAG) (((FLAG) == RTC_FLAG_RECALPF) || ((FLAG) == RTC_FLAG_SHPF) || \
							   ...
							   ((FLAG) == RTC_FLAG_WUTF)    || ((FLAG) == RTC_FLAG_WUTWF) || \
