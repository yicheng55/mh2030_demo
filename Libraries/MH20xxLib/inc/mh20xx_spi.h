...
#ifndef __MH20XX_SPI_H
#define __MH20XX_SPI_H
...
#define IS_SPI_FIRMH_BIT(BIT) (((BIT) == SPI_FirstBit_MSB) || \
...
#define IS_I2S_MHANDARD(MHANDARD) (((MHANDARD) == I2S_Standard_Phillips) || \
                                   ((MHANDARD) == I2S_Standard_MSB) || \
                                   ((MHANDARD) == I2S_Standard_LSB) || \
                                   ((MHANDARD) == I2S_Standard_PCMShort) || \
                                   ((MHANDARD) == I2S_Standard_PCMLong))
/**
  * @}
  */
...
#define IS_SPI_LAMH_DMA_TRANSFER(TRANSFER) (((TRANSFER) == SPI_LastDMATransfer_TxEvenRxEven) || \
