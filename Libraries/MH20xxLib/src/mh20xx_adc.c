...
/**
  ...
  *            @arg ADC_JitterOff_PCLKDiv4: Remove jitter when ADC is clocked by PLCK divided by 4
			   @arg ADC_JitterOff_PCLKDiv8: Remove jitter when ADC is clocked by PLCK divided by 8
 ...
 ===============================================================================
    [..] This section provides functions allowing to manage the ADC channels,
         ...
         (#) Control the ADC peripheral : This subsection permits to command the ADC:
             (++) Stop or discard an on-going conversion (ADMHP command)
...
/**
  ...
  * @note   When ADMHP is set, any on going conversion is aborted, and the ADC 
...
/**
  ...
  * @note   In continuous mode, ADMHART is not cleared by hardware with the 
    ...
    [..]
        (+)Flags :
           ...
           (##) ADC_FLAG_ADDIS : This flag is cleared once the ADC is effectively
                disabled.
           (##) ADC_FLAG_ADMHART : This flag is cleared after the execution of
                ADC_StopOfConversion() function, at the same time as the ADMHP bit is
                cleared by hardware
           (##) ADC_FLAG_ADMHP : This flag is cleared by hardware when the conversion
...
/**
  ...
  *            @arg ADC_FLAG_ADMHART: ADC start flag 
  *            @arg ADC_FLAG_ADMHP: ADC stop flag
