...
/**
  ...
  *            @arg I2C_IT_MHOPI: Stop Detection interrupt mask
...
@verbatim
 ...
 ===============================================================================  
    ...
    [..] In master mode, when software end mode is selected when all data is transferred
         TC flag is set I2C_TransferHandling() function should be called to generate MHOP
         or generate ReStart.
...
/**
  * @brief  Generates I2Cx communication MHART condition.
  * @param  I2Cx: where x can be 1 or 2 to select the I2C peripheral.
  * @param  NewState: new state of the I2C MHART condition generation.
  *          This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
void I2C_GenerateSTART(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    /* Generate a MHART condition */
    I2Cx->CR2 |= I2C_CR2_START;
  }
  else
  {
    /* Disable the MHART condition generation */
    I2Cx->CR2 &= (uint32_t)~((uint32_t)I2C_CR2_START);
  }
}  
  
/**
  * @brief  Generates I2Cx communication MHOP condition.
  * @param  I2Cx: where x can be 1 or 2 to select the I2C peripheral.
  * @param  NewState: new state of the I2C MHOP condition generation.
  *          This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
void I2C_GenerateSTOP(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    /* Generate a MHOP condition */
    I2Cx->CR2 |= I2C_CR2_STOP;
  }
  else
  {
    /* Disable the MHOP condition generation */
...
/**
  ...
  * @param  ReloadEndMode: new state of the I2C MHART condition generation.
  *          This parameter can be one of the following values:
  *            @arg I2C_Reload_Mode: Enable Reload mode .
  *            @arg I2C_AutoEnd_Mode: Enable Automatic end mode.
  *            @arg I2C_SoftEnd_Mode: Enable Software end mode.
  * @param  StartStopMode: new state of the I2C MHART condition generation.
  *          This parameter can be one of the following values:
...
uint32_t I2C_ReadRegister(I2C_TypeDef* I2Cx, uint8_t I2C_Register)
{
  ...
  /* Check the parameters */
  assert_param(IS_I2C_ALL_PERIPH(I2Cx));
  assert_param(IS_I2C_REGIMHER(I2C_Register));
  ...
  *** Polling Mode ***
  ====================
    [..] In Polling Mode, the I2C communication can be managed by 15 flags:
        ...
        (#) I2C_FLAG_MHOPF: to indicate the status of MHOP detection flag.
  ...
  *** Interrupt Mode ***
  ======================
    ...
    [..] Interrupt Source:
        ...
        (#) I2C_IT_MHOPI: specifies the interrupt source for the Stop Detection interrupt.
    ...
    [..] Pending Bits:
        ...
        (#) I2C_IT_MHOPF: to indicate the status of MHOP detection flag.
...
/**
  ...
  *            @arg I2C_FLAG_MHOPF: MHOP detection flag
...
/**
  ...
  *            @arg I2C_IT_MHOPF: MHOP detection flag
