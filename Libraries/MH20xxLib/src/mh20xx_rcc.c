...
/**
  ...
  * @note   The HSE is stopped by hardware when entering MHOP and MHANDBY modes.
...
/**
  ...
  *         HSE_MHARTUP_TIMEOUT in mh20xx.h file. You can tailor it depending
...
/**
  ...
  * @note   The HSI is stopped by hardware when entering MHOP and MHANDBY modes.
...
/**
  ...
  * @note   The HSI14 is stopped by hardware when entering MHOP and MHANDBY modes.
...
void RCC_PLLConfig(uint32_t RCC_PLLSource, uint32_t RCC_PLLMul)
{
  ...
  /* Clear PLL Source [16] and Multiplier [22:18] bits */
...
/**
  ...
  * @note   The PLL is disabled by hardware when entering MHOP and MHANDBY modes.
...
/**
  ...
  *         startup from Reset, wake-up from MHOP and MHANDBY mode, or in case
...
/**
  ...
  *             @arg RCC_ADCCLK_PCLK_Div8: ADC clock = PCLK/8  			
  * @retval None
  */
...
/**
  ...
  *         
  * @note     (*) HSI_VALUE is a constant defined in mh20xx.h file (default value
  *               8 MHz) but the real value may vary depending on the variations
  *               in voltage and temperature, refer to RCC_AdjustHSICalibrationValue().   
  *    
  * @note     (**) HSE_VALUE is a constant defined in mh20xx.h file (default value
...
void RCC_GetClocksFreq(RCC_ClocksTypeDef* RCC_Clocks)
{
  ...
  switch (tmp)
  {
    ...
    case 0x08:  /* PLL used as system clock */
	  ...
	  if((pllmull & RCC_CFGR_PLLMULL_4) == RCC_CFGR_PLLMULL_4)
	  {
		pllmull = ( pllmull >> 18) + 1;
	  }
	  else
	  {
 ...
 ===============================================================================  
    ...
    [..] This section provide functions allowing to configure the Peripheral clocks. 
         (#) The RTC clock which is derived from the LSE, LSI or  HSE_Div32 (HSE
             divided by 32).
         (#) After restart from Reset or wakeup from MHANDBY, all peripherals are off
...
/**
  ...
  *         work in MHOP and MHANDBY modes, and can be used as wakeup source.
  *         However, when the HSE clock is used as RTC clock source, the RTC
  *         cannot be used in MHOP and MHANDBY modes.
  *             
...
/**
  ...
  *           @arg RCC_APB1Periph_TIM6:   TIM7 clock
...
{
  /* Check the parameters */
  assert_param(IS_RCC_AHB_RMH_PERIPH(RCC_AHBPeriph));
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  *             @arg RCC_FLAG_OBLRMH: Option Byte Loader (OBL) reset 
  *             @arg RCC_FLAG_PINRMH: Pin reset
  *             @arg RCC_FLAG_V18PWRRMHF:  V1.8 power domain reset  
  *             @arg RCC_FLAG_PORRMH: POR/PDR reset
  *             @arg RCC_FLAG_SFTRMH: Software reset
  *             @arg RCC_FLAG_IWDGRMH: Independent Watchdog reset
  *             @arg RCC_FLAG_WWDGRMH: Window Watchdog reset
  *             @arg RCC_FLAG_LPWRRMH: Low Power reset
...
/**
  ...
  *         The reset flags are: RCC_FLAG_OBLRMH, RCC_FLAG_PINRMH, RCC_FLAG_V18PWRRMHF,
  *         RCC_FLAG_PORRMH, RCC_FLAG_SFTRMH, RCC_FLAG_IWDGRMH, RCC_FLAG_WWDGRMH,
  *         RCC_FLAG_LPWRRMH.
  * @param  None
  * @retval None
  */
