...
void SPI_Init(SPI_TypeDef* SPIx, SPI_InitTypeDef* SPI_InitStruct)
{
  ...
  assert_param(IS_SPI_FIRMH_BIT(SPI_InitStruct->SPI_FirstBit));
  ...
  /* Set MMHR bit according to SPI_Mode */
...
void I2S_Init(SPI_TypeDef* SPIx, I2S_InitTypeDef* I2S_InitStruct)
{
  ...
  assert_param(IS_I2S_MHANDARD(I2S_InitStruct->I2S_Standard));
...
/*----------------------- SPIx I2SCFGR & I2SPR Configuration -----------------*/
  /* Clear I2SMOD, I2SE, I2SCFG, PCMSYNC, I2SMHD, CKPOL, DATLEN and CHLEN bits */
...
@verbatim   
 ...
 ===============================================================================
    ...
    -@-
       ...
       SPI bandwidth.
       (+@) When the MHM32F0xx are configured as slaves and the NSS hardware mode is 
...
void SPI_LastDMATransferCmd(SPI_TypeDef* SPIx, uint16_t SPI_LastDMATransfer)
{
  /* Check the parameters */
  assert_param(IS_SPI_ALL_PERIPH(SPIx));
  assert_param(IS_SPI_LAMH_DMA_TRANSFER(SPI_LastDMATransfer));
