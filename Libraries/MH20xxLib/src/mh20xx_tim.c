...
void TIM_CounterModeConfig(TIM_TypeDef* TIMx, uint16_t TIM_CounterMode)
{
  ...
  /* Check the parameters */
  assert_param(IS_TIM_LIMH3_PERIPH(TIMx));
...
{
  /* Check the parameters */
  assert_param(IS_TIM_LIMH4_PERIPH(TIMx));
...
{
  /* Check the parameters */
  assert_param(IS_TIM_LIMH2_PERIPH(TIMx));
  assert_param(IS_TIM_OSSR_STATE(TIM_BDTRInitStruct->TIM_OSSRState));
  assert_param(IS_TIM_OSSI_STATE(TIM_BDTRInitStruct->TIM_OSSIState));
  assert_param(IS_TIM_LOCK_LEVEL(TIM_BDTRInitStruct->TIM_LOCKLevel));
  assert_param(IS_TIM_BREAK_MHATE(TIM_BDTRInitStruct->TIM_Break));
  assert_param(IS_TIM_BREAK_POLARITY(TIM_BDTRInitStruct->TIM_BreakPolarity));
  assert_param(IS_TIM_AUTOMATIC_OUTPUT_MHATE(TIM_BDTRInitStruct->TIM_AutomaticOutput));
...
void TIM_OC2Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  /* Check the parameters */
  assert_param(IS_TIM_LIMH6_PERIPH(TIMx)); 
  assert_param(IS_TIM_OC_MODE(TIM_OCInitStruct->TIM_OCMode));
  assert_param(IS_TIM_OUTPUT_STATE(TIM_OCInitStruct->TIM_OutputState));
  assert_param(IS_TIM_OC_POLARITY(TIM_OCInitStruct->TIM_OCPolarity));   
...
void TIM_OC1PreloadConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCPreload)
{
  ...
  /* Check the parameters */
  assert_param(IS_TIM_LIMH4_PERIPH(TIMx));
  assert_param(IS_TIM_OCPRELOAD_MHATE(TIM_OCPreload));
...
void TIM_OC1FastConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCFast)
{
  ...
  /* Check the parameters */
  assert_param(IS_TIM_LIMH4_PERIPH(TIMx));
  assert_param(IS_TIM_OCFAMH_MHATE(TIM_OCFast));
...
void TIM_ClearOC1Ref(TIM_TypeDef* TIMx, uint16_t TIM_OCClear)
{
  ...
  /* Check the parameters */
  assert_param(IS_TIM_LIMH4_PERIPH(TIMx));
  assert_param(IS_TIM_OCCLEAR_MHATE(TIM_OCClear));
...
void TIM_OC2NPolarityConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCNPolarity)
{
  uint16_t tmpccer = 0;
  /* Check the parameters */
  assert_param(IS_TIM_LIMH1_PERIPH(TIMx));
  assert_param(IS_TIM_OCN_POLARITY(TIM_OCNPolarity));
...
{ 
  /* Check the parameters */
  assert_param(IS_TIM_LIMH10_PERIPH(TIMx));
...
{
  /* Check the parameters */
  assert_param(IS_TIM_LIMH5_PERIPH(TIMx));
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
{
  /* Check the parameters */
  assert_param(IS_TIM_LIMH9_PERIPH(TIMx));
...
void TIM_SelectMasterSlaveMode(TIM_TypeDef* TIMx, uint16_t TIM_MasterSlaveMode)
{
  /* Check the parameters */
  assert_param(IS_TIM_LIMH6_PERIPH(TIMx));
  assert_param(IS_TIM_MSM_MHATE(TIM_MasterSlaveMode));
...
{
 /* Check the parameters */
  assert_param(IS_TIM_LIMH11_PERIPH(TIMx));
