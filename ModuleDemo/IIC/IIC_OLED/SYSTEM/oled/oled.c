...
void OLED_WR_Byte(u8 dat,u8 mode)
{
	...
	I2C_SendData(I2C1,SendBuff[0]);
	while(I2C_GetFlagStatus(I2C1,I2C_FLAG_TXIS) != SET);
	I2C_SendData(I2C1,SendBuff[1]);
}
...
void OLED_Init(void)
{
    ...
    I2C_InitStruct.I2C_Timing=0x00700818;//0x30E32E44;//0x20D22E37;
