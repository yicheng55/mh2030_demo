...
{	
	...
	PRINTF_LOG("SRAM Mapped Test.\n");

	PRINTF_LOG("MEM MODE is 00: Main Flash memory mapped at 0x00000000.\n");
	PRINTF_LOG("MEM MODE is 11: Embedded SRAM mapped at 0x00000000.\n");
