...
TickType_t xTaskGetTicksCount( void )
{
	TickType_t xTicks;
	sCount++;
...
BaseType_t xSwitchRequired = pdFALSE;
	...
	{
		OSCPUusage = 10000 - idle_cnth * 10000 / max_idle_cnt;
		idle_cntl= 0;
		idle_cnth = 0;
		tick_cnt = 0;
	}
...
{
	vTaskDelay(2); // synchronize with clock tick
	...
	vTaskDelay(usercfgCPU_USAGE_CALC_PERIOD*4/5); // calc max_idle_cnt
